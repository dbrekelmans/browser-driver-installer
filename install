...
use DBrekelmans\BrowserDriverInstaller\Command\GoogleChromeCommand;
...
$application->add(
    new GoogleChromeCommand($filesystem, $browserFactory, $driverFactory, $driverDownloaderFactory)
);
